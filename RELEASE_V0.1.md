...
Исследование опирается прежде всего на официальные страницы iiko: актуальный продукт «Кафе», базу знаний iikoWeb, настройки ресторанов/терминалов/внешних меню, официальный анонс смены API-авторизации 2026 года, договоры API для технологических партнёров и официальный магазин connectors. Exact request schemas новой авторизации и POS events должны быть окончательно сверены с текущей API schema после выдачи реальных developer credentials.
