...
class RefundPreviewRequest(StaffScopedRequest): gross_refund_minor:int|None=Field(default=None,gt=0)
class RefundPreviewResponse(BaseModel): gross_refund_minor:int; paid_refund_minor:int; restored_points:int; reversed_earned_points:int; qualification_reversal_minor:int; remaining_gross_minor:int
